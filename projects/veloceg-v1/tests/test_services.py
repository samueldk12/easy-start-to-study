...
ENABLED_TOOLS = set(['iceberg_rest', 'kafka_ui', 'spark', 'dbt', 'airflow', 'minio', 'trino', 'jupyterlab', 'schema_registry', 'vscode', 'kafka', 'kafka_connect', 'postgres'])
CUSTOM_PORTS = {}
...
def run_all_tests():
    print("=" * 70)
    print(f" {Colors.BOLD}{Colors.CYAN}[*] STACKSTUDIO SERVICE TEST SUITE: VELOCEG-V1{Colors.END}")
    print("=" * 70)

...
# Instalar extensoes recomendadas em background para nao bloquear o arranque do editor
if [ "$AUTO_INSTALL_EXTENSIONS" = "true" ] && [ -f /home/coder/project/.vscode/extensions.json ]; then
  (
    ...
    for ext in ms-azuretools.vscode-docker ms-python.python ms-python.vscode-pylance ms-toolsai.jupyter cweijan.vscode-database-client2 mtxr.sqltools mtxr.sqltools-driver-pg ckolkman.vscode-postgres redhat.vscode-yaml eamodio.gitlens innoverio.vscode-dbt-power-user formulahendry.vscode-kafka; do

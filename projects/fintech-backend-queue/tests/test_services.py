...
ENABLED_TOOLS = set(['postgres', 'rabbitmq', 'keycloak', 'redis', 'hasura'])
...
def run_all_tests():
    print("=" * 70)
    print(f" {Colors.BOLD}{Colors.CYAN}[*] STACKSTUDIO SERVICE TEST SUITE: FINTECH-BACKEND-QUEUE{Colors.END}")
    print("=" * 70)

...
ENABLED_TOOLS = set(['postgres', 'redis', 'rabbitmq'])
CUSTOM_PORTS = {}
...
def run_all_tests():
    print("=" * 70)
    print(f" {Colors.BOLD}{Colors.CYAN}[*] STACKSTUDIO SERVICE TEST SUITE: CRYPTO-TRADING-STREAM{Colors.END}")
    print("=" * 70)

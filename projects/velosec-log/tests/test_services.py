...
ENABLED_TOOLS = set(['spark', 'airflow', 'kafka', 'kafka_connect', 'kafka_ui', 'trino', 'iceberg_rest', 'minio', 'schema_registry', 'postgres'])
CUSTOM_PORTS = {}
...
def run_all_tests():
    print("=" * 70)
    print(f" {Colors.BOLD}{Colors.CYAN}[*] STACKSTUDIO SERVICE TEST SUITE: VELOSEC-LOG{Colors.END}")
    print("=" * 70)

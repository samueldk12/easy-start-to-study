...
ENABLED_TOOLS = set(['redis', 'ansible', 'terraform', 'nginx', 'vscode', 'apigateway', 'postgres'])
CUSTOM_PORTS = {}
...
def run_all_tests():
    print("=" * 70)
    print(f" {Colors.BOLD}{Colors.CYAN}[*] STACKSTUDIO SERVICE TEST SUITE: DEVOPS-EDGE-STACK{Colors.END}")
    print("=" * 70)

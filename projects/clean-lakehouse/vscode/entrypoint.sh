...
if [ "$AUTO_INSTALL_EXTENSIONS" = "true" ] && [ -f /home/coder/project/.vscode/extensions.json ]; then
  ...
  for ext in redhat.vscode-yaml eamodio.gitlens ms-azuretools.vscode-docker ms-python.python ms-toolsai.jupyter formulahendry.vscode-kafka ckolkman.vscode-postgres mtxr.sqltools; do

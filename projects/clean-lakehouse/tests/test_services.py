...
ENABLED_TOOLS = set(['spark', 'airflow', 'kafka', 'trino', 'iceberg_rest', 'minio', 'postgres'])
CUSTOM_PORTS = {}
...
def run_all_tests():
    print("=" * 70)
    print(f" {Colors.BOLD}{Colors.CYAN}[*] STACKSTUDIO SERVICE TEST SUITE: CLEAN-LAKEHOUSE{Colors.END}")
    print("=" * 70)

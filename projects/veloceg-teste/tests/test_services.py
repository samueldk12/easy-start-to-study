...
ENABLED_TOOLS = set(['superset', 'kafka', 'kafka_ui', 'postgres', 'doris', 'kafka_connect', 'clickhouse', 'airflow', 'flink', 'redpanda', 'minio', 'spark', 'iceberg_rest'])
CUSTOM_PORTS = {}
...
def run_all_tests():
    print("=" * 70)
    print(f" {Colors.BOLD}{Colors.CYAN}[*] STACKSTUDIO SERVICE TEST SUITE: VELOCEG-TESTE{Colors.END}")
    print("=" * 70)

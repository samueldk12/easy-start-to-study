...
ENABLED_TOOLS = set(['qdrant', 'postgres', 'minio', 'jupyterlab', 'redis', 'mlflow'])
...
def run_all_tests():
    print("=" * 70)
    print(f" {Colors.BOLD}{Colors.CYAN}[*] STACKSTUDIO SERVICE TEST SUITE: ECOMMERCE-MLOPS{Colors.END}")
    print("=" * 70)
